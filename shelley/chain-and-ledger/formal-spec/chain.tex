...
The Block Header Transition checks a couple of sizes and performs some chain level
...
\begin{figure}
  ...
  \begin{equation*}
    ...
    \powerset (\powerset{\KeyHashGen} \times \NewEpochState \times \BHeader \times \NewEpochState)
  \end{equation*}
